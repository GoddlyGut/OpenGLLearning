...
int main()
{
	...
	// -------------------------
	Shader skyboxShader("shaders/cubemaps_skybox/skybox.vert", "shaders/cubemaps_skybox/skybox.frag");
    Shader shader("shaders/cubemaps_skybox/cubemaps.vert", "shaders/cubemaps_skybox/cubemaps.frag");
