...
int main()
{
    ...
    unsigned int diffuseMap = loadTexture(FileSystem::getPath("resources/images/container2.png").c_str());
    unsigned int specularMap = loadTexture(FileSystem::getPath("resources/images/container2_specular.png").c_str());
